...
NDS::NDS() : spi(this), cp15(this), spu(this), dma {DMA(this), DMA(this)}, arm9(this, 1), arm7(this, 0), timers {Timers(this), Timers(this)}, gpu(this), memory(this), cartridge(this), interrupt(this), ipc(this), rtc(this) {
