    ...
    while (window.isOpen()) {
        ...
        if (show_interrupts_window) {
            ...
            if (ImGui::CollapsingHeader("ARM7 Interrupts")) {
                bool arm7_ime_set = core->interrupt[0].IME & 0x1;
                bool arm7_vblank_irq_enable = core->interrupt[0].IE & 0x1;
                bool arm7_vblank_irq_request = core->interrupt[0].IF & 0x1;
                bool arm7_hblank_irq_enable = core->interrupt[0].IE & (1 << 1);
                bool arm7_hblank_irq_request = core->interrupt[0].IF & (1 << 1);
                bool arm7_lyc_irq_enable = core->interrupt[0].IE & (1 << 2);
                bool arm7_lyc_irq_request = core->interrupt[0].IF & (1 << 2);
                bool arm7_timer0_irq_enable = core->interrupt[0].IE & (1 << 3);
                bool arm7_timer0_irq_request = core->interrupt[0].IF & (1 << 3);
                bool arm7_timer1_irq_enable = core->interrupt[0].IE & (1 << 4);
                bool arm7_timer1_irq_request = core->interrupt[0].IF & (1 << 4);
                bool arm7_timer2_irq_enable = core->interrupt[0].IE & (1 << 5);
                bool arm7_timer2_irq_request = core->interrupt[0].IF & (1 << 5);
                bool arm7_timer3_irq_enable = core->interrupt[0].IE & (1 << 6);
                bool arm7_timer3_irq_request = core->interrupt[0].IF & (1 << 6);
                bool arm7_dma0_irq_enable = core->interrupt[0].IE & (1 << 7);
                bool arm7_dma0_irq_request = core->interrupt[0].IF & (1 << 7);
                bool arm7_dma1_irq_enable = core->interrupt[0].IE & (1 << 8);
                bool arm7_dma1_irq_request = core->interrupt[0].IF & (1 << 8);
                bool arm7_dma2_irq_enable = core->interrupt[0].IE & (1 << 9);
                bool arm7_dma2_irq_request = core->interrupt[0].IF & (1 << 9);
                bool arm7_dma3_irq_enable = core->interrupt[0].IE & (1 << 10);
                bool arm7_dma3_irq_request = core->interrupt[0].IF & (1 << 10);
