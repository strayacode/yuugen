...
u32 CP15::Read(u32 cn, u32 cm, u32 cp) {
    log_fatal("handle when we implement the nds core again");
...
void CP15::Write(u32 cn, u32 cm, u32 cp, u32 data) {
    ...
    //     nds.arm9_memory.UpdateMemoryMap(0, itcm_size);
    //     nds.arm9_memory.UpdateMemoryMap(dtcm_base, dtcm_base + dtcm_size);
    //     break;
    // case 0x020000:
    //     // pu cachability bits for data/unified protection region
    //     break;
    ...
    //     nds.arm9_memory.UpdateMemoryMap(old_dtcm_base, old_dtcm_base + old_dtcm_size);
    //     nds.arm9_memory.UpdateMemoryMap(dtcm_base, dtcm_base + dtcm_size);
    ...
    //     nds.arm9_memory.UpdateMemoryMap(0, std::max(old_itcm_size, itcm_size));
