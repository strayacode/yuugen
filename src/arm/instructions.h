...
struct ARMDataProcessing {
    ...
    static ARMDataProcessing decode(u32 instruction) {
        ...
        opcode.rd = static_cast<GPR>(common::get_field<12, 4>(instruction));
        opcode.rn = static_cast<GPR>(common::get_field<16, 4>(instruction));
        ...
        if (opcode.imm) {
            ...
            opcode.rhs.reg.rm = static_cast<GPR>(common::get_field<0, 4>(instruction));
            ...
            if (opcode.rhs.reg.imm) {
                ...
                opcode.rhs.reg.amount.rs = static_cast<GPR>(common::get_field<8, 4>(instruction));
            }
        }
    ...
    union {
        ...
        struct {
            ...
            bool imm;
            union {
                GPR rs; // shift by a value specified in a register
...
struct ARMMultiply {
    static ARMMultiply decode(u32 instruction) {
        ...
        opcode.rs = static_cast<GPR>(common::get_field<8, 4>(instruction));
        opcode.rn = static_cast<GPR>(common::get_field<12, 4>(instruction));
        opcode.rd = static_cast<GPR>(common::get_field<16, 4>(instruction));
        return opcode;
    }
...
struct ARMMultiplyLong {
    static ARMMultiplyLong decode(u32 instruction) {
        ...
        opcode.rm = static_cast<GPR>(common::get_field<0, 4>(instruction));
        opcode.rs = static_cast<GPR>(common::get_field<8, 4>(instruction));
        opcode.rdlo = static_cast<GPR>(common::get_field<12, 4>(instruction));
        opcode.rdhi = static_cast<GPR>(common::get_field<16, 4>(instruction));
        return opcode;
    }
...
struct ARMHalfwordDataTransfer {
    static ARMHalfwordDataTransfer decode(u32 instruction) {
        ...
        if (opcode.imm) {
            ...
            opcode.rhs.rm = static_cast<GPR>(common::get_field<0, 4>(instruction));
        }
...
struct ARMCoprocessorRegisterTransfer {
    static ARMCoprocessorRegisterTransfer decode(u32 instruction) {
        ...
        opcode.crm = static_cast<GPR>(common::get_field<0, 4>(instruction));
        opcode.crn = static_cast<GPR>(common::get_field<16, 4>(instruction));
...
struct ThumbAddSubtract {
    static ThumbAddSubtract decode(u16 instruction) {
        ...
        opcode.rd = static_cast<GPR>(common::get_field<0, 3>(instruction));
        opcode.rs = static_cast<GPR>(common::get_field<3, 3>(instruction));
        opcode.rn = static_cast<GPR>(common::get_field<6, 3>(instruction));
...
struct ThumbALUImmediate {
    ...
    static ThumbALUImmediate decode(u16 instruction) {
        ...
        opcode.rd = static_cast<GPR>(common::get_field<8, 3>(instruction));
...
struct ThumbSpecialDataProcessing {
    ...
    static ThumbSpecialDataProcessing decode(u16 instruction) {
        ...
        opcode.rd = static_cast<GPR>((common::get_bit<7>(instruction) << 3) | (common::get_field<0, 3>(instruction)));
        opcode.rs = static_cast<GPR>(common::get_field<3, 4>(instruction));
...
struct ThumbBranchExchange {
    static ThumbBranchExchange decode(u16 instruction) {
        ...
        opcode.rm = static_cast<GPR>(common::get_field<3, 4>(instruction));
        return opcode;
    }
...
struct ThumbLoadStoreRegisterOffset {
    ...
    static ThumbLoadStoreRegisterOffset decode(u16 instruction) {
        ...
        opcode.rd = static_cast<GPR>(common::get_field<0, 3>(instruction));
        opcode.rn = static_cast<GPR>(common::get_field<3, 3>(instruction));
        opcode.rm = static_cast<GPR>(common::get_field<6, 3>(instruction));
...
struct ThumbLoadStoreMultiple {
    static ThumbLoadStoreMultiple decode(u16 instruction) {
        ...
        opcode.rlist = common::get_field<0, 8>(instruction);
        opcode.rn = static_cast<GPR>(common::get_field<8, 3>(instruction));
        opcode.load = common::get_bit<11>(instruction);
        return opcode;
    }
