...
void Translator::translate() {
    ...
    // LOG_INFO("Translator: translate basic block instruction size %d pc %08x", location.get_instruction_size(), location.get_address());
...
Translator::BlockStatus Translator::illegal_instruction() {
    LOG_ERROR("Translator: illegal instruction %08x at pc = %08x", instruction, jit.get_gpr(GPR::PC));
